...
const DrawHeatmap = (svg, curData) => {
    ...
    const margin = {
        ...
        let ticksDomain = [null, ...legendDomain, null]
        ...
        rects.selectAll("rect")
            ...
            .on('mouseover', function (event, d) {
                ...
                let tooltipContent = d.year.getFullYear() + " - " + monthArr[d.month - 1] + "</br>"
                    + d.temperature + "</br>"
                    + d.variance;
                ...
                // tooltipText.append("tspan").attr("x", 0).text("XXXXX")
                // tooltipText.append("tspan").attr("x", 0).attr("dy", "1em").text("XXXXX")
